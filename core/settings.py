...
SECRET_KEY = 'django-insecure-sb)0k$w2xaa8+z^s=@0*hrje^+u)zeescp@la-ey+f!0y2$wko'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'blog.context_processors.extrect',
            ],
        },
    },
]
...
EMAIL_HOST_USER = "mdfaiz@gmail.com"
EMAIL_HOST_PASSWORD = "tvua wqhm ribz bbyr"
EMAIL_PORT = 587